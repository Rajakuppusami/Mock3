...
public class Car {
	...
	public Car(String licenceNumber, String model, Double currentMileage, Integer engineSize) {
		super();
		this.licenceNumber = licenceNumber;
		this.model = model;
		this.currentMileage = currentMileage;
	...
	public String toString() {
		return "Licence Number:"+this.licenceNumber+"\nModel:"+this.model;
	}
    ...
    public static Car findCar(String licNo, ArrayList<Car> carList) {
       //fill the code
    	...
    	for(Car value:carList){
    		if(value.getLicenceNumber().equals(licNo)){
    			c=value;
    			break;
    		}
    	}
